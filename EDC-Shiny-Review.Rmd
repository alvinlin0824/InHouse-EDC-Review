...
```{r eval = is.character(params$data1)}
# ae1 <- read_sas(gsub("\\\\", "/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-16157_InHouse Sensor\OpenClinicaExtract\Current\088\ae1.sas7bdat)"))
...
str_length(ae1$AEDTC01) != median(str_length(ae1$AEDTC01),na.rm = T) |
...
str_length(ae1$AESTDT01) != median(str_length(ae1$AESTDT01),na.rm = T) |
# onset date and time
...
(str_detect(ae1$AEDUR01,regex("Resolved or resolved with sequelae|Death",ignore_case = T)) & str_length(ae1$AEENDT01) != median(str_length(ae1$AEENDT01),na.rm = T)) |
# Outcome time
...
str_length(ae1$AEDTC03) != median(str_length(ae1$AEDTC03),na.rm = T),][,-c(1,3,5:13)] %>%
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "ae1",height = 600,
...
`r if(is.character(params$data1)){median(str_length(ae1$AEDTC01),na.rm = T)}` `r if(is.character(params$data1)){colorize(ae1[(str_length(ae1$AEDTC01) != median(str_length(ae1$AEDTC01),na.rm = T)),]$Subject,"red")}`
...
`r if(is.character(params$data1)){knitr::asis_output("13. Length of AESTDT01 (Onset date) should be")}` `r if(is.character(params$data1)){median(str_length(ae1$AESTDT01),na.rm = T)}` `r if(is.character(params$data1)){colorize(ae1[(str_length(ae1$AESTDT01) != median(str_length(ae1$AESTDT01),na.rm = T)),]$Subject,"red")}`
...
`r if(is.character(params$data1)){knitr::asis_output("30. Length of AEDTC03(Investigator Acknowledgement) should be")}` `r if(is.character(params$data1)){median(str_length(ae1$AEDTC03),na.rm = T)}` `r if(is.character(params$data1)){colorize(ae1[(str_length(ae1$AEDTC03) != median(str_length(ae1$AEDTC03),na.rm = T)),]$Subject,"red")}`
...
```{r eval = is.character(params$data2)}
...
ae2[
    ...
    sjlabelled::label_to_colnames() %>%
    reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "ae2",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
```{r eval = is.character(params$data4)}
# de <- read_sas(gsub("\\\\", "/", r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-16157_InHouse Sensor\OpenClinicaExtract\Current\088\de.sas7bdat)"))
...
str_detect(de$DEORES07,"[:alpha:]") & (str_detect(de$DESPID01,"^$|pattern") | str_detect(de$DESPID07,"^$|pattern")),][,-c(1,3,5:13)] %>% 
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "de",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
```{r eval = is.character(params$data5)}
...
!str_detect(dm$DMDEXT,regex("Right|Left|Ambidextrous",ignore_case = T))
    ,][,-c(1,3,5:13)] %>% 
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "dm",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
```{r eval = is.character(params$data6)}
# du1 <- read_sas(gsub("\\\\", "/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-16157_InHouse Sensor\OpenClinicaExtract\Current\088\du1.sas7bdat)"))
...
du1[str_length(du1$DUNUM2) != median(str_length(du1$DUNUM2),na.rm = T) |
...
is.na(du1$DUORES2) | str_detect(du1$DUORES2,"^$|pattern") | 
...
str_length(du1$DULOC) != median(str_length(du1$DULOC),na.rm = T) |
# Relative Position (string)
str_detect(du1$DUPOS,"^$|pattern") |
# Did the subject experience any pain? (string)
str_detect(du1$DUORES24,"^$|pattern") |
# If yes, how severe? If yes, describe (string)
str_detect(du1$DUORES24,"Yes") & (str_detect(du1$DUORES4,"^$|pattern") | str_detect(du1$DUORES5,"^$|pattern"))                                   |
# Were inserter assembly and insertion processes successful? (string)
str_detect(du1$DUORES6,"^$|pattern") |
# If no, select issues
str_detect(du1$DUORES6,"No") & (str_detect(du1$DUORES7,"^$|pattern")) ,][,-c(1,3,5:13)] %>%
  sjlabelled::label_to_colnames() %>% 
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "du1",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
`r if(is.character(params$data6)){knitr::asis_output("1. Length of DUNUM2(sensor serial number) default is")}` `r if(is.character(params$data6)){median(str_length(du1$DUNUM2),na.rm = T)}` `r if(is.character(params$data6)){colorize(du1[str_length(du1$DUNUM2) != median(str_length(du1$DUNUM2),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("2. Length of DUDTC1(Insertion Date) default is")}` `r if(is.character(params$data6)){median(str_length(du1$DUDTC1),na.rm = T)}`
...
`r if(is.character(params$data6)){knitr::asis_output("3. Length of DUTM1(Insertion Time (24 hr)) default is")}` `r if(is.character(params$data6)){median(str_length(du1$DUTM1),na.rm = T)}` `r if(is.character(params$data6)){colorize(du1[str_length(du1$DUTM1) != median(str_length(du1$DUTM1),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("4. DUORES2(Did it puncture the skin?) should not be blank")}` `r if(is.character(params$data6)){colorize(du1[is.na(du1$DUORES2) | str_detect(du1$DUORES2,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("5. Length of condition code default is")}` `r if(is.character(params$data6)){median(str_length(du1$DUCD),na.rm = T)}` `r if(is.character(params$data6)){colorize(du1[str_length(du1$DUCD) != median(str_length(du1$DUCD),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("6. DUNUM3(PDU/SDU Lot Number(s)) and DUORES3(PDU/SDU Lot Number(s) NA) should not be blank at the same time")}` `r if(is.character(params$data6)){colorize(du1[str_detect(du1$DUNUM3,"^$|pattern") & str_detect(du1$DUORES3,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("7. Length of DULOC(Insertion Location) default is")}` `r if(is.character(params$data6)){median(str_length(du1$DULOC),na.rm = T)}` `r if(is.character(params$data6)){colorize(du1[str_length(du1$DULOC) != median(str_length(du1$DULOC),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("8. DUPOS (Relative Position) should not be blank")}` `r if(is.character(params$data6)){colorize(du1[str_detect(du1$DUPOS,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("9. DUORES24(Did the subject experience any pain?) should not be blank")}` `r if(is.character(params$data6)){colorize(du1[str_detect(du1$DUORES24,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("10. DUORES24(Did the subject experience any pain?) if Yes, DUORES4(If yes, how severe?) and DUORES5(If yes, describe) should not be blank at the same time")}` `r if(is.character(params$data6)){colorize(du1[str_detect(du1$DUORES24,"Yes") & (str_detect(du1$DUORES4,"^$|pattern") | str_detect(du1$DUORES5,"^$|pattern")),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("11. DUORES6(Were inserter assembly and insertion processes successful?) shoud not be blank")}` `r if(is.character(params$data6)){colorize(du1[str_detect(du1$DUORES6,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data6)){knitr::asis_output("12. DUORES6(Were inserter assembly and insertion processes successful?) if No, DUORES7(If yes, select issue) and DUDESC2(If other,  specify) should not be blank at the same time")}` `r if(is.character(params$data6)){colorize(du1[str_detect(du1$DUORES6,"No") & (str_detect(du1$DUORES7,"^$|pattern")),]$Subject,"red")}`
...
```{r eval = is.character(params$data7)}
# du2 <- read_sas(gsub("\\\\", "/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-16157_InHouse Sensor\OpenClinicaExtract\Current\102\du2.sas7bdat)"))
...
du2[str_length(du2$DUNUM6) != median(str_length(du2$DUNUM6),na.rm = T) |
#  Connection
str_detect(du2$DUORES8,"^$|pattern") |
# Was the sensor startup process successful?
str_detect(du2$DUORES9,"^$|pattern") |
# Was the sensor startup process successful? if yes
str_detect(du2$DUORES9,"Yes") & str_detect(du2$DUTM2,"^$|pattern")
      ,][,-c(1,3,5:13)] %>%
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "du2",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
`r if(is.character(params$data7)){knitr::asis_output("2. DUORES9(Was the sensor startup process successful?) should not be blank")}` `r if(is.character(params$data7)){colorize(du2[str_detect(du2$DUORES9,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data7)){knitr::asis_output("3. If DUORES9(Was the sensor startup process successful?) is Yes,DUTM2(time displayed on reader) should not be blank")}` `r if(is.character(params$data7)){colorize(du2[str_detect(du2$DUORES9,"Yes") & str_detect(du2$DUTM2,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data7)){knitr::asis_output("4. Length of DUNUM6(Reader/Phone Serial Number) default is")}` `r if(is.character(params$data7)){median(str_length(du2$DUNUM6))}` `r if(is.character(params$data7)){colorize(du2[str_length(du2$DUNUM6) != median(str_length(du2$DUNUM6)),]$Subject,"red")}`
...
```{r eval = is.character(params$data8)}
# du3 <- read_sas(gsub("\\\\", "/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-16157_InHouse Sensor\OpenClinicaExtract\Current\102\du3.sas7bdat)"))
...
str_detect(du3$DUORES17,regex("Yes",ignore_case = T)) & str_detect(du3$DUCOM,"^$|pattern"),][,-c(1,3,5:13)] %>%
  # sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "du3",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
`r if(is.character(params$data8)){knitr::asis_output("9. DUORES16(Removed By) should be Clinical Staff,Fell/Knocked Off,Study Subject")}` `r if(is.character(params$data8)){colorize(du3[!str_detect(du3$DUORES16,"Clinical Staff|Fell/Knocked Off|Study Subject"),]$Subject,"red")}`
...
```{r eval = is.character(params$data11)}
...
!str_detect(du4$DUORES19,regex("Yes|No",ignore_case = T)),][,-c(1,3,5:13)] %>%
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "du4",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
```{r eval = is.character(params$data12)}
...
str_detect(du5$DUORES21,regex("Yes",ignore_case = T)) & is.na(du5$DUORES21),][,-c(1,3,5:13)] %>%   sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "du5",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
`r if(is.character(params$data12)){knitr::asis_output("2. If DUORES21 yes,DUDTC5(If yes, date first applied:) should not be NA")}` `r if(is.character(params$data12)){colorize(du5[str_detect(du5$DUORES21,regex("Yes",ignore_case = T)) & is.na(du5$DUORES21),]$Subject,"red")}`
...
```{r eval = is.character(params$data13)}
...
is.na(ie$IEDTC) | str_length(ie$IEDTC) != median(str_length(ie$IEDTC),na.rm = T),][,-c(1,3,5:13)] %>% 
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "ie",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
```{r eval = is.character(params$data14)}
...
str_detect(mh$MHORRES2,regex("Yes",ignore_case = T)) & (!str_detect(mh$MHDTC1,regex("Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec",ignore_case = T)) | str_detect(mh$MHDTC2,"^$|pattern") | !str_detect(mh$MHORRES3,regex("Type 1|Type 2",ignore_case = T))),][,-c(1,3,5:13)] %>% 
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "mh",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
```{r eval = is.character(params$data9)}
# pd <- read_sas(gsub("\\\\", "/", r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-16157_InHouse Sensor\OpenClinicaExtract\Current\088\pd.sas7bdat)"))
...
str_length(pd$DVDTC3) != median(str_length(pd$DVDTC3),na.rm = T),][,-c(1,3,5:13)] %>%
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "pd",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
`r if(is.character(params$data9)){knitr::asis_output("4. The length of DVDTC2(Date Reported) should be")}` `r if(is.character(params$data9)){median(str_length(pd$DVDTC2),na.rm = T)}` `r if(is.character(params$data9)){colorize(pd[str_length(pd$DVDTC2) != median(str_length(pd$DVDTC2),na.rm = T),]$Subject,"red")}`
...
`r if(is.character(params$data9)){knitr::asis_output("13. The length of DVDTC3(Principal Investigator Acknowledgement: Date) should be")}` `r if(is.character(params$data9)){median(str_length(pd$DVDTC3),na.rm = T)}``r if(is.character(params$data9)){colorize(pd[str_length(pd$DVDTC3) != median(str_length(pd$DVDTC3),na.rm = T),]$Subject,"red")}`
...
```{r eval = is.character(params$data10)}
...
,][,-c(1,3,5:13)] %>%
  sjlabelled::label_to_colnames() %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE,elementId = "vs",height = 600,
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
